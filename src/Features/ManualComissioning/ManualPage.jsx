...
// import NavbarSuspension from './NavbarManual';
...
// import StepperSuspension from './StepperManual';
// import SuspensionWarning from './manualWarning';
...
//     store.getState()?.master?.masterData?.suspensionReasons || [];
//   const reasons = [
//     {
...
//   );
//   const onSubmitSuspension = async (e, values) => {    
...
//     //   .then((resp) => {
//     //     history.push({
//     //       pathname: '/digital-prm-web-ui/suspenseapproval',
//     //       details: resp.data
//     //     });
//     //   })
//     //   .catch((error) => {
...
//       <SuspensionWarning
//         open={openWarning}
//         handleSubmit={onSubmitSuspension}
...
// export default withRouter(Suspension);
