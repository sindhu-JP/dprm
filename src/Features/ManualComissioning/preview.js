...
const ProductDetails = ({ title, productData, maintitle, mobileNo, email }) => {
  ...
  useEffect(() => {
    ...
    console.log(obj, "capturex")

    delete obj?.PartnerDetails?.Partner_Suspension_Request
    delete obj?.PartnerDetails?.Performance_Status
    delete obj?.PartnerDetails?.RISK_CATEGORY

    Product.setValue(obj);
  }, [productData]);

  console.log(Product.value, "capture")
  return (
    <>
