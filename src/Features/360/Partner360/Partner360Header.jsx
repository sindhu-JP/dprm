...
// import MaskGroupIcon from '../../../Assets/Icons/MaskGroupNew.svg'
            ...
            >
              ...
              <Grid item>
                ...
                props?.partnerdetails?.mainlist?.OnboardStatus === 'CLOSED' ? (
                  ...
                  <div  className='manageHeaderHierarchy'>
                  <Button 
                    variant="outlined"
                    // color="primary"
                    // className={classes.button}
              ...
              <Grid
                ...
                // backgroundImage={MaskGroupIcon}
              >
                  <div className='masknewGrid'>
                <img src={require('../../../Assets/Icons/MaskGroupNew.svg')} />
              </div>
