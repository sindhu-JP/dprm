...
import Chicklets from '../TroubleTicket/Components/Chicklets';
import { Trans } from '@lingui/react';
import { Badge } from 'antd';
import filter from 'Assets/Icons/Filter.svg';
import SearchIcon from '@material-ui/icons/Search';
import TicketStatusCard from './TroubleTicket/Components/TicketStatusCard';
import dummydata from 'Features/Partner360/TroubleTicket/Components/Dummydata';
import getAssociate from 'Features/Partner360/TroubleTicket/Components/DataFactory/Ticket';
import TicketDetailsWrapper from './TroubleTicket/Dashboard/TicketDetailsWrapper';
        ...
        <Grid container direction="column" spacing={6}>
          <Grid item xs>
            <Grid container direction="row" justifyContent="space-between">
              <Grid item>
                <Typography className='partnerHead' variant="h1">Partner TICKETS</Typography>
              </Grid>
              {/* <Grid item>
                <Select
                  value={'oneday'}
                      ...
                      <Grid item xs={12}>
                        ...
                        <div className="ticketPagination">
                          <TablePagination
                            ...
                            rowsPerPage={limit}
                            page={offset}
                            onChangePage={(e, offset) => handleOffset(offset)}
