...
import NavbarSuspension from './NavbarSuspension';
...
import StepperSuspension from './StepperSuspension';
...
const Suspension = (props) => {
  ...
  const suspension_reasons =
    store.getState()?.master?.masterData?.suspensionReasons || reasons;
  ...
  const onSubmitSuspension = async (values) => {    
