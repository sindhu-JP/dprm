...
import ProductDetails from 'Features/TaskDetails/ProductDetails/suspendProduct';
          ...
          <Grid container direction="row" justifyContent="space-between">
            <Grid item>
              <Typography variant="h2">
                {values?.relatedData?.partner?.PartnerDetails?.Partner_ID
                  ? 'Partner'
                  : 'Tenant'}
          ...
          <Grid item xs={12} style={{ padding: '0px' }}>
            {values?.relatedEntity && (
              <ProductDetails
                ...
                values={values?.relatedData?.partnerSuspension}
              />
            )}
          </Grid>
        </Grid>
