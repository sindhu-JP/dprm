...
import ProductDetails from 'Features/TaskDetails/ProductDetails/ManualDetails';
...
const TicketDetails = ({
  ...
  const classes = styles();
  console.log(values, 'syattttsyatttt11');
          ...
          <Grid item xs={12} style={{padding:"0px"}}>
            {values?.relatedEntity && (
              <ProductDetails
                ...
                productData={values?.relatedData?.partner}
                values={values?.relatedData?.manualCommission}
                ticket={values}
              />
            )}
          </Grid>
