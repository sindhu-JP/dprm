...
import ProductDetails from 'Features/TaskDetails/ProductDetails/leadDetails';
...
const TicketDetails = ({
  ...
  //console.log(getparser(AssignUserList), AssignUserList, 'title');
  const onClick = (event) => {
    event.stopPropagation();
    setAnchorEl(event.currentTarget);
    //('selected item', event.currentTarget);
  };
  ...
  // console.log(selectedVal, 'valuess');
            ...
            {values?.relatedEntity && (
              <>
                <ProductDetails
                  ...
                  productData={values?.relatedData?.leadPartner}
                  values={values?.relatedData?.leadPartner}
                  ticket={values}
                />
              </>
            )}
