...
import ProductDetails from 'Features/TaskDetails/ProductDetails/ResellerDetails';
          ...
          <Grid item xs={12} style={{ padding: '0px' }}>
            {values?.relatedEntity && (
              <ProductDetails
                ...
                productData={values?.relatedData?.reseller}
                values={values?.relatedData?.reseller}
                ticket={values}
              />
            )}
          </Grid>
