...
const FileUpload = ({
  ...
  React.useEffect(() => {
    if (upload && upload.fomrdatavalue) {
              ...
              <Grid container direction="column" spacing={6}>
                <Grid item>
                  <Grid container alignItems="center" justify="space-between">
                    <Grid item>
                      <Typography variant="h2">{attachmentID}</Typography>
                    </Grid>
                ...
                <Grid item>
                  <Grid container spacing={10}>
                    <Grid item xs={3}>
                      <TextField
                        ...
                        value={
                          companyregid
                            ? companyregid
                            : upload.details['companyRegistrationNumber']
                        }
                        fullWidth
                    ...
                    <Grid item xs={3}>
                      <KeyboardDatePicker
                        disabled={expiryDate ? true : false}
                        required
                        // disableToolbar
                        format="MM/dd/yyyy"
                        label="EXPIRY DATE"
                        disablePast
                        value={
                          expiryDate ? expiryDate : upload.details['expiryDate']
                        }
                        onChange={(e) => {
                          upload.updateDetails({
                            target: {
