...
import ManualComissionSearch from "Features/ManualComissioning/ManualCommissioning";
...
const Subscription = (props) => {
  ...
  const handleClickOpenManualCommissioning = () => {
    setOpenManualCommissioning(true);
    setOpenList(true);   
  };
  ...
  const [openManualCommissioning, setOpenManualCommissioning] = React.useState(false);
  ...
  return (
    <div className={classes.mainWrapper} onMouseLeave={props.handlemounseCard}>
        ...
        <Grid item>
          ...
          <List>
            ...
            <ListItem
              ...
              onClick={handleClickOpenManualCommissioning}
            >
              <ListItemText>
                
                <Trans id="Manual Commissioning "></Trans>
                </ListItemText>
            </ListItem>
          </List>
        </Grid>
      ...
      <PartnerSearch
        ...
        scroll={scroll}
      />
      <ManualComissionSearch
        open={openManualCommissioning}
        setOpen={setOpenManualCommissioning}
        scroll={scroll}
      />
      <RevokePartnerSearch
