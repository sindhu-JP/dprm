...
const AgentShareContract = (props) => {
  ...
  const getProductDetails = async () => {
    let Details = await PartnerApi.getProductDetails(
      props.modalcontext?.rowlist?.PRODUCT_ID
    );

    ProdcutDetails.setValue(_.get(Details, '[0]', ''));
  };
  React.useEffect(() => {
    if (props.modalcontext?.rowlist?.PRODUCT_ID) {
      // Product contract
          ...
          <Grid item xs={6}>
            ...
            <Grid item>
              <Typography variant="body1">
                <span> {props.agent?.AgentDetails?.FIRST_NAME}</span>
                <span> {props.agent?.AgentDetails?.LAST_NAME}</span>
              </Typography>
            </Grid>
          </Grid>
          <Grid item xs={6}>
            ...
            <Grid item>
              <Typography variant="body1">
                {props.agent?.AgentDetails?.EMAIL}
              </Typography>
            </Grid>
          </Grid>
          <Grid item xs={6}>
            ...
            <Grid item>
              <Typography variant="body1">
                {props.agent?.AgentDetails?.AGENT_MOBILE_NUMBER}
              </Typography>
            </Grid>
          </Grid>
          <Grid item xs={6}>
          ...
          <Grid item xs={6}>
            ...
            <Grid item>
              ...
              <Link
                ...
                onClick={() =>
                  props.downloadpdf({
                    id: props.agent.AgentDetails.Dynamic_Contract_Pdf
                  })
                }
              >
                Link
          ...
          >
            ...
            <Grid item style={{ textAlign: 'center' }}>
              <Button
                ...
                onClick={() => {
                  props.handleShareContract(props.agent);
                }}
              >
...
export default AgentShareContract;
