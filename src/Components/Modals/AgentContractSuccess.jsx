...
import StepperAgent from './AgentStepper';
...
const AgentContractSuccess = (props, context, fromSuccess) => {

    console.log(props.location?.details?.Values, "properxxxxxxx")
                  ...
                  >
                    ...
                    <Grid item>
                      <Typography variant="subtitle1">
                        <Trans id=" Agent contract created successfully, Approval pending."></Trans>
                      </Typography>
                    </Grid>
                    <Grid item>
                          ...
                          <Grid container>
                            ...
                            <Grid item style={{ width: '100px' }}>
                              <Typography
                                ...
                                className={classes.textColor}
                              >
                                 {props.location?.details?.Values?.Agent_ID}
                          ...
                          <Grid container>
                            ...
                            <Grid item style={{ width: '100px' }}>
                              <Typography
                                ...
                                className={classes.textColor}
                              >
                                {props.location?.details?.Values?.AGENT_NAME || props.location?.details?.Values?.Agent_Name}
...
export default AgentContractSuccess;
